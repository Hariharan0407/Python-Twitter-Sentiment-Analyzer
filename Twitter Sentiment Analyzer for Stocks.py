...
# word cloud is a visual representation of words. The bigger the size of the word the more prominent it was used in in given
# text data. usually used to analyze social media texts.
from nltk.sentiment.vader import SentimentIntensityAnalyzer
# sentiment is a subpackage and vader is a submodule
import snscrape.modules.twitter as sntwitter
# snscrape module is used to scrape tweets without Twitter API authentication
import nltk
# nltk - Native Language Toolkit


nltk.download('vader_lexicon') #required for sentiment analysis
# VADER = Valense Aware Dictionary and sEntiment Reasoner
# lexicon is a dictionary or vocabulary of a particular subkect or language
# get user input
query = input('Query: ')
# as long as the query is valid and not empty or equal to '#'
if query != '':
